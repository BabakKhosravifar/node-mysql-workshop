...
console.log("#".bold.yellow+colors.bold.yellow(row.id)+": "+ row.email+ " ("+"Password:".cyan+colors.green(returnString(row.password))+ " ,"+"createdAt: ".cyan+colors.green(colors.green(returnString(row.createdAt)))+ " ,"+"modifiedAt:".cyan+colors.green(returnString(row.modifiedAt))+")");
  });
